...
import {getToken, doLogout} from '../service/LoginService'

export default ({children, title = 'Main Application'})=> (
		<div id='wrapper'>
        <nav className='navbar navbar-inverse navbar-fixed-top' role='navigation'>
            ...
            <ul className='nav navbar-right top-nav'>
                ...
                <li className='dropdown'>
                    <a href='#' className='dropdown-toggle' data-toggle='dropdown'><i className='fa fa-user'></i> {getToken().username} <b className='caret'></b></a>
                    <ul className='dropdown-menu'>
                        ...
                        <li className='divider'></li>
                        <li>
                            <a href='#' onClick={doLogout}><i className='fa fa-fw fa-power-off'></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>
